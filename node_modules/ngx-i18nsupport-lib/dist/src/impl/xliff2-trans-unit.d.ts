...
export declare class Xliff2TransUnit extends AbstractTransUnit implements ITransUnit {
     ...
     */
    private parseSourceAndPos(sourceAndPos);
    private parseLineNumber(lineNumberString);
    /**
     ...
     */
    private findNoteElementWithCategoryAttribute(attrValue);
    /**
     * Create a new note element with attribute from='<attrValue>'
     * @param {string} attrValue
     * @return the new created element
     */
    private createNoteElementWithCategoryAttribute(attrValue);
    /**
     * Remove note element with attribute from='<attrValue>'
     * @param {string} attrValue
     */
    private removeNoteElementWithCategoryAttribute(attrValue);
    /**
