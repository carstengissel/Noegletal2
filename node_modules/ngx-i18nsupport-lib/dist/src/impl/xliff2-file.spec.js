 ...
 */
describe('ngx-i18nsupport-lib XLIFF 2.0 test spec', function () {
    ...
    function readFile(path) {
        ...
        return api_1.TranslationMessagesFileFactory.fromFileContent('xlf2', content, path, ENCODING);
    }
    describe('XLIFF 2.0 format tests', function () {
        var MASTER1SRC = SRCDIR + 'ngExtractedMaster1.xlf2';
        var TRANSLATED_FILE_SRC = SRCDIR + 'translatedFile.xlf2';
        var ID_APP_RUNS = '4371668001355139802'; // an ID from ngExtractedMaster1.xlf
        var ID_WITH_PLACEHOLDER = '9030312858648510700';
        var ID_WITH_REPEATED_PLACEHOLDER = '7049669989298349710';
        var ID_WITH_MEANING_AND_DESCRIPTION = '6830980354990918030';
        var ID_WITH_NO_SOURCEREFS = '4371668001355139802'; // an ID with no source elements
        var ID_WITH_ONE_SOURCEREF = '7499557905529977371';
        var ID_WITH_TWO_SOURCEREFS = '3274258156935474372'; // an ID with 2 source elements
        var ID_WITH_TAGS = '7609655310648429098';
        var ID_WITH_STRANGE_TAG = '7610784844464920497';
        var ID_TO_MERGE = 'unittomerge';
        var ID_ICU_PLURAL = '157616252019374389';
        var ID_ICU_SELECT = '6710804210857077394';
        ...
        var ID_CONTAINS_TWO_ICU_WITH_EQUIV = 'complextags.icuTwoICU.withEquiv'; // angular issue #17344
        ...
        it('should read xlf file', function () {
            ...
            var tu = file.transUnitWithId(ID_APP_RUNS);
            expect(tu).toBeTruthy();
            expect(tu.sourceContent()).toBe('Anwendung läuft!');
        });
        it('should read xlf2 file and pretty print it and read it in again', function () {
            var file = readFile(TRANSLATED_FILE_SRC);
            expect(file).toBeTruthy();
            var formattedXml = file.editedContent(true);
            var rereadFile = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(formattedXml, null, null);
        ...
        it('should not add empty lines when beautifying (issue ngx-i18nsupport #97)', function () {
            ...
            var file2 = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(editedContentBeautified, null, null);
        ...
        it('should set description (creates new description)', function () {
            ...
            var notesElem = dom_utilities_1.DOMUtilities.getFirstElementByTagName(xmlElem, 'notes');
        ...
        it('should normalize unknown embedded html tags', function () {
            var file = readFile(TRANSLATED_FILE_SRC);
            var tu = file.transUnitWithId(ID_WITH_STRANGE_TAG);
        ...
        it('should remove a transunit by id', function () {
            ...
            var file2 = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(file.editedContent(), null, null);
            var tu2 = file2.transUnitWithId(ID_WITH_PLACEHOLDER);
        ...
        it('should translate source without or with target', function () {
            ...
            var file2 = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(file.editedContent(), null, null);
            var tu2 = file2.transUnitWithId(ID_APP_RUNS);
            ...
            var tu3 = file3.transUnitWithId(ID_APP_RUNS);
        ...
        it('should copy a transunit to a specified position (#53)', function () {
            ...
            var targetFile = readFile(TRANSLATED_FILE_SRC);
            expect(targetFile.transUnitWithId(ID_TO_MERGE)).toBeFalsy();
            var ID_EXISTING = '7499557905529977371';
            ...
            var existingElem = dom_utilities_1.DOMUtilities.getElementByTagNameAndId(doc, 'unit', ID_EXISTING);
            var newElem = dom_utilities_1.DOMUtilities.getElementByTagNameAndId(doc, 'unit', ID_TO_MERGE);
        ...
        it('should translate placeholders without loosing disp info', function () {
            var file = readFile(MASTER1SRC);
            var tu = file.transUnitWithId(ID_WITH_PLACEHOLDER);
            expect(tu).toBeTruthy();
            ...
            var translatedMessage = normalizedMessage.translate('Total {{1}}, added {{0}}');
        ...
        it('should contain 2 ICU references in sourceContentNormalized (old syntax before angular #17344)', function () {
            var file = readFile(MASTER1SRC);
        ...
        it('should contain 2 ICU references in sourceContentNormalized (new syntax after angular #17344)', function () {
            var file = readFile(MASTER1SRC);
            var tu = file.transUnitWithId(ID_CONTAINS_TWO_ICU_WITH_EQUIV);
            expect(tu).toBeTruthy();
        ...
        it('should translate ICU references without loosing disp info', function () {
            var file = readFile(MASTER1SRC);
            var tu = file.transUnitWithId(ID_CONTAINS_TWO_ICU_WITH_EQUIV);
            expect(tu).toBeTruthy();
            var normalizedMessage = tu.sourceContentNormalized();
            expect(normalizedMessage.asDisplayString()).toBe('first: <ICU-Message-Ref_0/>, second <ICU-Message-Ref_1/>');
            var translatedMessage = normalizedMessage.translate('Zweitens <ICU-Message-Ref_1/>, Erstens: <ICU-Message-Ref_0/>');
            tu.translate(translatedMessage);
...
//# sourceMappingURL=S:/experimente/ngx-i18nsupport-lib/src/impl/xliff2-file.spec.js.map