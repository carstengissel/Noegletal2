...
var XtbFile = /** @class */ (function (_super) {
     ...
     * @return {XmbFile}
     */
    function XtbFile(xmlString, path, encoding, optionalMaster) {
    ...
    XtbFile.prototype.initializeFromContent = function (xmlString, path, encoding, optionalMaster) {
        ...
        if (optionalMaster) {
            try {
                this._masterFile = new xmb_file_1.XmbFile(optionalMaster.xmlContent, optionalMaster.path, optionalMaster.encoding);
...
//# sourceMappingURL=S:/experimente/ngx-i18nsupport-lib/src/impl/xtb-file.js.map